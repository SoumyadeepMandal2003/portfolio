...
export const Footer = () => (
  <footer className="w-full bg-black border-t border-white/10 py-6">
    <div className="max-w-5xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-2 text-gray-400 text-sm">
      <div>
        &copy; {new Date().getFullYear()} Soumyadeep Mandal. All rights
        reserved.
      </div>
