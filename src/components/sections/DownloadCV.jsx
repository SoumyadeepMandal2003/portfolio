...
export const DownloadCV = () => (
  <section
    id="download-cv"
    className="min-h-[50vh] flex items-center justify-center py-20 bg-black text-gray-100"
  >
    <RevealOnScroll>
      <div className="text-center z-10 px-4">
        ...
        <p className="mb-8 text-lg text-gray-300">
          Want to know more about my skills and experience? <br />
          Download my resume!
        </p>
        <a
          href="https://drive.google.com/uc?export=download&id=16aEhVtraGjubXrnB42OtJO-k4zXxsuIM"
          className="bg-blue-500 text-white py-3 px-8 rounded font-medium transition-all duration-200 hover:-translate-y-0.5 hover:shadow-[0_0_15px_rgba(59,130,246,0.4)] hover:bg-blue-600 text-lg"
          download
        >
          Download CV
        </a>
        <div className="flex justify-center gap-6 mt-8">
          <a
            ...
            className="inline-flex gap-2 items-center bg-gray-800 hover:bg-gray-700 text-white px-5 py-3 rounded transition shadow"
            title="GitHub"
          >
            <svg
              aria-hidden="true"
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex gap-2 items-center bg-blue-700 hover:bg-blue-600 text-white px-5 py-3 rounded transition shadow"
            title="LinkedIn"
          >
            <svg
              aria-hidden="true"
